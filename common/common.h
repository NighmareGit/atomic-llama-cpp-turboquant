...
struct common_params {
    ...
    int32_t override_moe_top_k    =     0; // [EXPERIMENTAL] override MoE routed top-k (0 = native)
    ...
    std::string device_order;           // --device-order: "gpu,rpc" or "rpc,gpu" (default: rpc,gpu)
    float   device_overhead[128] = {0}; // per-device memory overhead to reserve (MiB) for auto-split
