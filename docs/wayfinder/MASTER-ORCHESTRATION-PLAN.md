...
| Slice 7 Re-examination + Follow-up Leads | 📋 ready | D7-REEXAMINATION completed 2026-07-17. D7.13: ~~dual-issue CLOSED~~ (ISA), ~~nwarps=8 CLOSED~~ (regression). **IU4 WMMA (Idea 6) + V_DOT8 (Idea 7) NEW** from ISA analysis. D7.14-D7.16: LDS root-cause, FA+Q4_K_M, FAST/SLOW. `docs/wayfinder/D7-REEXAMINATION.md`, `docs/research/gfx1100-hardware-deep-dive.md`. |
