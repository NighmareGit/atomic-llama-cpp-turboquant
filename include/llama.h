...
extern "C" {
    ...
    struct llama_model_params {
        ...
        // Devices should also appear in `devices` (or be loadable). Not used when NULL.
        const ggml_backend_dev_t * layer_devices;
        int32_t n_layer_devices;
    ...
    struct llama_context_params {
        ...
        int32_t  override_moe_top_k; // [EXPERIMENTAL] override the number of routed experts (MoE top-k) executed during inference (0 = native behavior)
