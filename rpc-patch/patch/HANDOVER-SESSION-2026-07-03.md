...
| Location | Path | Notes |
|----------|------|-------|
| **romulus (primary client)** | `user@192.168.8.108` -> `~/atomic-llama-cpp-turboquant` | 5-GPU prod client; benches run here |
| **remus** | `user@192.168.8.176` | RPC0 5060 `:50051` |
| **triton** | `user@192.168.8.23` | RPC2 3090 `:50054`, RPC3 3070 `:50055` |
