...
export BENCH_RPC_ENDPOINT="${BENCH_RPC_ENDPOINT:-192.168.8.176:50051,192.168.8.176:50052,127.0.0.1:50051,192.168.8.21:50053}"
export BENCH_TS="${BENCH_TS:-26,12,12,26,24}"
