...
echo "  4-GPU gate (b6-4gpu-g-triton):"
...
echo "  5-GPU Linux (b6-5gpu-g, no jupiter):"
echo "    RPC0 remus 5060     -> ${REMUS_HOST}:50051"
echo "    RPC1 romulus 3060   -> 127.0.0.1:50051"
echo "    RPC2 triton 3090+3070 -> ${TRITON_HOST}:50054 (-d CUDA0,CUDA1)"
echo "    ROCm0 romulus 7900  -> local on ${ROMULUS_HOST}"
echo "  6-GPU Linux (b6-6gpu-g, jupiter re-enabled):"
echo "    RPC0 remus 5060     -> ${REMUS_HOST}:50051"
echo "    RPC1 romulus 3060   -> 127.0.0.1:50051"
echo "    RPC2 triton 3090     -> ${TRITON_HOST}:50054"
echo "    RPC3 triton 3070     -> ${TRITON_HOST}:50055"
echo "    RPC4 jupiter 5070    -> 192.168.8.21:50053"
echo "    ROCm0 romulus 7900   -> local on ${ROMULUS_HOST}"
echo "  excluded: remus RX6600 :50052"